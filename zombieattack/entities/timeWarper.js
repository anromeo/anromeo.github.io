...
function TimeWarper(game) {
    ...
    this.movingAnimationImage = ASSET_MANAGER.getAsset("./images/alternative-shooter-walking.png");
    ...
    this.ability2PictureInactive = ASSET_MANAGER.getAsset("./images/timewarper-ability2-inactive.png");
    this.ability2PictureActive = ASSET_MANAGER.getAsset("./images/timewarper-ability2-active.png");


    this.ability1PictureActive = ASSET_MANAGER.getAsset("./images/timewarper-ability1-active.png");
    this.ability1PictureInactive = ASSET_MANAGER.getAsset("./images/timewarper-ability1-inactive.png");

    this.ability2Attributes.cooldown = 8;
    this.ability2Attributes.maxCooldown = 8;
...
TimeWarper.prototype.ability1 = function(entity) {
    ...
    entity.timerForSlowDown = 8;
}

TimeWarper.prototype.ability2 = function(entity) {
    console.log("Freezing Time");
    entity.timerForFreeze = 4;
}

TimeWarper.prototype.attack = function(target) {
